...
<head>
    ...
    <link type="text/css" rel="stylesheet" href="{{asset('invoice/css/bootstrap.min.css')}}">
    <link type="text/css" rel="stylesheet" href="{{asset('invoice/fonts/font-awesome/css/font-awesome.min.css')}}">

    <!-- Favicon icon -->
    <link rel="shortcut icon" href="{{asset('invoice/img/favicon.ico')}}" type="image/x-icon" >
                            ...
                            <div class="row">
                                <div class="col-sm-6">
                                    <div class="invoice-name">
                                        <!-- logo started -->
                                        <div class="logo">
                                            <img src="{{asset('invoice/img/logos/logo.png')}}" alt="logo">
                                        </div>
                                        <!-- logo ended -->
                                    </div>
                                </div>
                                <div class="col-sm-6">
                                    <div class="invoice">
                                        ...
                                        <h1 class="text-end inv-header-1 mb-0">Invoice No: {{$allInfo->order_no}}</h1>
                                    </div>
                                </div>
                            </div>
                        </div>
...
<script src="{{asset('invoice/js/html2canvas.js')}}"></script>
<script src="{{asset('invoice/js/app.js')}}"></script>
</body>
</html>
